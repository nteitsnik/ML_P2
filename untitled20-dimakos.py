...
fake_news = pd.read_csv(r'C:\Users\USER\Desktop\Machine Learning\Fake.csv')
true_news = pd.read_csv(r'C:\Users\USER\Desktop\Machine Learning\True.csv')
...
# Filter out rows containing 'Washington Post' in the text
data = data[~data['text'].str.contains('washington post', case=False, na=False)].reset_index(drop=True)
